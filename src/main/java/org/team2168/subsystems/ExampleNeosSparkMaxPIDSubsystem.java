 ...
 * Add your docs here.
 */
public class ExampleNeosSparkMaxPIDSubsystem extends Subsystem {
  ...
  private static ExampleNeosSparkMaxPIDSubsystem _instance; 

  private ExampleNeosSparkMaxPIDSubsystem() {
        ...
        SmartDashboard.putBoolean("Velocity Mode", false);
  }
  /**
   * 
   * @return singleton object of the type ExampleNeosSparkMaxPIDSubsystem
   */
  public static ExampleNeosSparkMaxPIDSubsystem getInstance() {
    if(_instance == null) {
      _instance = new ExampleNeosSparkMaxPIDSubsystem();
    }
    return _instance;

...
public class Shooter extends Subsystem {
    ...
    private final double WALL_VEL =2590.0; //
    private final double WHITE_LINE_VEL = 3290.0; //untuned
    private final double FRONT_TRENCH_VEL = 4400.0; //steady state: 40 over
    private final double BACK_TRENCH_VEL = 4590.0; //4540.0; //steady state: 40 over 4500
